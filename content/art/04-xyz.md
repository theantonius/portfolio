...
list:
  ...
  - Sound and vocal composition by Jessika Kenney
  - EEG data, custom sleep-lab instrumentation, and sonification / visualization by Antonius Oki Wiriadjaja
  - Commissioned by Asia Society Museum for Creative Common Ground
exhibitions:
  - Asia Society Museum, New York — If We Were XYZ (premiere, commissioned by Creative Common Ground) — October 18–19, 2019
press:
  - title: "A Performer Uses Brain-Mapping Technology to Scan Her Dreams"
    publication: Hyperallergic
    url: https://hyperallergic.com/521598/melati-suryodarmo-if-we-were-xyz/
  - title: "If We Were XYZ"
    publication: Asia Society
    url: https://asiasociety.org/new-york/events/if-we-were-xyz
